...
const ListingDetails = () => {
    ...
    // Getting the listingId by using params
    ...
    const dayCount = Math.round(end - start) / (1000 * 60 * 60 * 24); // Calculate the difference in dates unit
                ...
                <div className="booking">
                    ...
                    <div>
                        ...
                        <div className="date-range-calender">
                            ...
                            <h2>Total prce: ${listing.price * dayCount}</h2>
                            <p>
                                Start Date:{" "}
